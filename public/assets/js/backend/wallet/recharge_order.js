            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'trade_num', title: __('Trade_num'), operate:'BETWEEN', sortable: true},
                        {field: 'status', title: __('交易状态'), searchList: {'success':"交易成功",'fail':"交易失败",'pending':'等待确认'}, formatter: Table.api.formatter.status},
                        {field: 'trade_time', title: __('Trade_time'), operate:'RANGE', addclass:'datetimerange', formatter: Table.api.formatter.datetime, sortable: true},
